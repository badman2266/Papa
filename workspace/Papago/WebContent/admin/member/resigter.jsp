			...
			<form class="form-horizontal" role="form"
				...
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="password" class="form-control" id="inputPassword"
								name="bean.mpassword" placeholder="Password">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" id="inputAddr"
								placeholder="地址" name="bean.memAddress">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<select class="form-control" id="select1" name="bean.memstatusId">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<select class="form-control" id="select2"  name="bean.memtypeId">
