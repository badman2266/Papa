...
<li ></li>
<body>
	<button type="submit" name="papaAction" value="Insert" class="btn btn-primary" onclick="XXX()">送出</button>
	<form action='<c:url value="/admin/message/papamsg.action" />' method="get">

		<div>
			<textarea name="bean.msgContent" rows="2" cols="50" class="ugccmt-comments-post-field" style="height: 46px;" title="" placeholder=""></textarea>
		</div>
