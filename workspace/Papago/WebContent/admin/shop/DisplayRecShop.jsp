						...
						<tbody>
							<c:forEach var="bean" items="${select}">
								...
								<tr>
									...
									<td>${bean.note}</td>
									<td><a href="${path}">新增</a></td>
									<td><a href="DelRecShop.jsp?bean.recId=${bean.recId}">刪除</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
