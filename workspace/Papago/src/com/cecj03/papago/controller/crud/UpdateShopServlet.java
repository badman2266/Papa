...
@WebServlet(
		urlPatterns={"/admin/shop/updateshop.controller"}
		)
...
public class UpdateShopServlet extends HttpServlet {
	...
	//轉換資料
		...
		if (errors != null && !errors.isEmpty()) {
			request.getRequestDispatcher("/admin/shop/UpdateShop.jsp").forward(request, response);
			return;
		}
